...
class mainWindow(wx.Frame):
	def __init__(self):
		...
		self.changeFilamentWizardMenuItem = expertMenu.Append(-1, _("Change Filament..."))
		self.Bind(wx.EVT_MENU, self.OnChangeFilamentWizard, self.changeFilamentWizardMenuItem)
		...
		i = helpMenu.Append(-1, _("miniFactory keskustelufoorumit..."))
		self.Bind(wx.EVT_MENU, lambda e: webbrowser.open('http://www.minifactory.fi/forum'), i)
		i = helpMenu.Append(-1, _("miniFactory Facebook-sivu..."))
		self.Bind(wx.EVT_MENU, lambda e: webbrowser.open('http://www.facebook.com/miniFactory.fi'), i)
	...
	def OnChangeFilamentWizard(self, e):
		configWizard.changeFilamentWizard()
